...
api.prototype.sendTrytes = function(trytes, depth, minWeightMagnitude, callback) {
    ...
    self.getNodeInfo(depth, function(error, nodeInfo) {
        ...
        var trunkTransaction = nodeInfo.latestSolidSubtangleMilestone;
        var branchTransaction = nodeInfo.latestSolidSubtangleMilestone;

        self.attachToTangle(trunkTransaction, branchTransaction, minWeightMagnitude, trytes, function(error, attached) {
